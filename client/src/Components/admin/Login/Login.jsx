            ...
            <div class="container-fluid h-custom">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div class="col-md-9 col-lg-6 col-xl-5">
                        <img src="https://c4.wallpaperflare.com/wallpaper/461/18/546/disney-disney-pixar-movies-animated-movies-wallpaper-preview.jpg" class="img-fluid" alt="Sample image" />
                    </div>
